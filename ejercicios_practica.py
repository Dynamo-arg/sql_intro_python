...
def fill():
    ...
    insert_persona("Sebastian", 30 , 2, "Martinez")
    insert_persona("Martin", 23 , 3, "Gonzalez")
    insert_persona("Jose", 33 , 4, "")
    insert_persona("Maria", 22 , 3, "Martinez")
    insert_persona("Karina", 18 , 1, "Martinez")
